...
const CCTVFinder = () => {
  ...
  return (
    <div className="h-screen w-full bg-gray-100 relative">
      {/* ✅ Header (Bigger Text) */}
      <header className="text-center py-6 bg-gray-800 text-white text-3xl font-bold">
        CCTV Finder
      </header>

      {/* ✅ Search Bar */}
      {user && (
        <div className="absolute top-20 left-1/2 transform -translate-x-1/2 z-10 w-full max-w-lg">
          <input
            type="text"
